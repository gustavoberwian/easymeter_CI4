			...
			<section>
		        <div class="container">
		            <div class="row">
		                ...
		                <div class="col-md-4 col-sm-6">
		                    <div class="outer-title text-center">
		                        <a href="<?php echo base_url('site/faq'); ?>#perguntas"><img alt="FAQs" src="<?php echo base_url('assets/img/faqs.png'); ?>"></a>
		                        <div class="title mb16">
		                ...
		                <div class="col-md-4 col-sm-6">
		                    <div class="outer-title text-center">
                                <a href="<?php echo base_url('site/chamados'); ?>#chamados"><img alt="Suppot Tickets" src="<?php echo base_url('assets/img/tickets.png'); ?>"></a>
		                        <div class="title mb16">
